...
export function ensureCorrectVersion() {
    ...
    traceError('Incompatible Python extension. Please update `scider.python` to version 2024.23 or later.');
    throw new Error('Incompatible Python extension. Please update `scider.python` to version 2024.23 or later.');
}
